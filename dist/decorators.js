...
const Required = (target, propertyName) => {
    var _a, _b;
    registerValidator[target.constructor.name] = Object.assign(Object.assign({}, registerValidator[target.constructor.name]), { [propertyName]: [
            ...((_b = (_a = registerValidator[target.constructor.name]) === null || _a === void 0 ? void 0 : _a[propertyName]) !== null && _b !== void 0 ? _b : []),
            'required',
        ] });
};
